...
import { GameEvent, GameNotifiier } from './gameNotifier';
...
export function SimonGame(props) {
    ...
    async function onPressed(buttonPosition) {
        if(allowPlayer) {
            ...
            await buttonPosition.get(buttonsPosition).ref.current.press();
    ...
    async function saveScore(score) {
        ...
        try {
            ...
            //store what the service gave us as the high score
    ...
    buttons.set('button-bottom-left', { postition: 'button-bottom-left', ref: React.useRef() });
